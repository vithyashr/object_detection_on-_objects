...
text(objects[i].label + " " + percent + " % " , objects[i].x + 20, objects[i].y - 90)
noFill("")
stroke("white")
rect(objects[i].x+10, objects[i].y-100, objects[i].width, objects[i].height)
text.weight("bold")
    }
